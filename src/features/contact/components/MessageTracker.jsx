...
import Section from "@/components/ui/Section"; // Importamos Section
...
const MessageTracker = () => {
  ...
  return (
    <Section title="Rastrea tu Mensaje" bgClass="section--gray" id="tracker">
          ...
          {status ? (
            ...
            <div className="animate-fade-in">
              <div className="tracker__result-header">
                ...
                <div>
                  <h4 className="tracker__result-title">Ticket Encontrado</h4>
                  <p className="tracker__result-id">ID: {status.id}</p>
                </div>
              </div>
              ...
              <div className="tracker__result-grid">
                <div className="tracker__result-item">
                  ...
                  <div>
                    <span className="tracker__result-label">Solicitante</span>
                ...
                <div className="tracker__result-item">
                  ...
                  <div>
                    <span className="tracker__result-label">Fecha</span>
                    <span className="tracker__result-value">
                      {status.fecha}
                    </span>
                  </div>
              ...
              <div className="tracker__result-footer">
                <div className="tracker__result-status-wrapper">
                  <span className="tracker__result-status-label">Estado:</span>
                  <span
